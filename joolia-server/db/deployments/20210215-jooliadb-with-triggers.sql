...
CREATE TABLE `activity` (
  ...
  KEY `FK_72d2e57f824d488c48281819cd6` (`createdById`),
  ...
  CONSTRAINT `FK_72d2e57f824d488c48281819cd6` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`activity_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`activity_ad_tg` AFTER DELETE
    ON `jooliadb`.`activity`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`activity_configuration_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`activity_template_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`activity_template_ad_tg` AFTER DELETE
    ON `jooliadb`.`activity_template`
    FOR EACH ROW
BEGIN
    DELETE FROM `jooliadb`.`activity_configuration` WHERE id=OLD.configurationId;
...
CREATE TABLE `canvas` (
  ...
  `canvasType` enum('process','questionnaire','business_canvas','custom_canvas') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'business_canvas',
  ...
  KEY `FK_d7345c1d54493a2f9c46d6a9f70` (`createdById`),
  ...
  CONSTRAINT `FK_d7345c1d54493a2f9c46d6a9f70` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`canvas_bd_tg` BEFORE DELETE
    ON `jooliadb`.`canvas`
    FOR EACH ROW
BEGIN
...
CREATE TABLE `canvas_slot` (
  ...
  `slotType` enum('title_only','title_and_submissions','submissions_only') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'title_and_submissions',
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`canvas_slot_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`canvas_submission_bd_tg` BEFORE DELETE
...
CREATE TABLE `file_entry` (
  ...
  `ownerType` enum('FormatEntry','ActivityEntry','SubmissionEntry','KeyVisual','FormatTemplateEntry','ActivityTemplateEntry','AvatarEntry','TeamAvatarEntry','TeamEntry','WorkspaceLogo') COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`file_entry_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`format_bd_tg` BEFORE DELETE
    ON `jooliadb`.`format`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`format_ad_tg` AFTER DELETE
    ON `jooliadb`.`format`
    FOR EACH ROW
BEGIN
    DELETE FROM `jooliadb`.`key_visual_entry` WHERE id=OLD.keyVisualId;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`format_member_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`format_template_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`format_template_ad_tg` AFTER DELETE
    ON `jooliadb`.`format_template`
    FOR EACH ROW
BEGIN
    DELETE FROM `jooliadb`.`key_visual_entry` WHERE id=OLD.keyVisualId;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`key_visual_entry_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`library_bd_tg` BEFORE DELETE
    ON `jooliadb`.`library`
    FOR EACH ROW
BEGIN
...
CREATE TABLE `link_entry` (
  ...
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `createdById` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` enum('Zoom','Skype','MSTeams','BBB','Collaboration','KeyVisual') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `activityId` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`link_entry_bd_tg` BEFORE DELETE
...
CREATE TABLE `phase` (
  ...
  KEY `FK_5f8fe8b1d90254079d2d44dc265` (`createdById`),
  CONSTRAINT `FK_5f8fe8b1d90254079d2d44dc265` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`phase_bd_tg` BEFORE DELETE
    ON `jooliadb`.`phase`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`phase_template_bd_tg` BEFORE DELETE
...
CREATE TABLE `skill` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_0f49a593960360f6f85b692aca` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `step` (
  ...
  KEY `FK_e1808be8826dd1ee36662e77953` (`createdById`),
  ...
  CONSTRAINT `FK_e1808be8826dd1ee36662e77953` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`step_bd_tg` BEFORE DELETE
    ON `jooliadb`.`step`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`step_check_bd_tg` BEFORE DELETE
...
CREATE TABLE `step_template` (
  ...
  KEY `FK_922fcbff45ffa5c0e08e3bf5ae4` (`createdById`),
  ...
  CONSTRAINT `FK_922fcbff45ffa5c0e08e3bf5ae4` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`step_template_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`submission_bd_tg` BEFORE DELETE
...
CREATE TABLE `team` (
  ...
  UNIQUE KEY `REL_8d492fbab912da2d67b6870246` (`meetingLinkId`),
  ...
  CONSTRAINT `FK_8d492fbab912da2d67b68702463` FOREIGN KEY (`meetingLinkId`) REFERENCES `link_entry` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`team_bd_tg` BEFORE DELETE
    ON `jooliadb`.`team`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`team_ad_tg` AFTER DELETE
    ON `jooliadb`.`team`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`team_members_format_member_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_bd_tg` BEFORE DELETE
    ON `jooliadb`.`user`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_ad_tg` AFTER DELETE
    ON `jooliadb`.`user`
    FOR EACH ROW
BEGIN
    DELETE FROM `jooliadb`.`file_entry` WHERE id=OLD.avatarId;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_comment_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_libraries_library_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_rating_bd_tg` BEFORE DELETE
...
CREATE TABLE `user_skill` (
  `skillId` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `userId` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`skillId`,`userId`),
  KEY `FK_03260daf2df95f4492cc8eb00e6` (`userId`),
  CONSTRAINT `FK_03260daf2df95f4492cc8eb00e6` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_49db81d31fc330a905af3c01205` FOREIGN KEY (`skillId`) REFERENCES `skill` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`user_skill_bd_tg` BEFORE DELETE
...
CREATE TABLE `workspace` (
  ...
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `createdById` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `logoId` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  UNIQUE KEY `REL_4d870f349c930d1125efb1a1f5` (`logoId`),
  KEY `FK_fb730da36fb79e21e8fa5f2c303` (`createdById`),
  CONSTRAINT `FK_4d870f349c930d1125efb1a1f55` FOREIGN KEY (`logoId`) REFERENCES `file_entry` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_fb730da36fb79e21e8fa5f2c303` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`workspace_bd_tg` BEFORE DELETE
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`workspace_ad_tg` AFTER DELETE
    ON `jooliadb`.`workspace`
    FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `jooliadb`.`workspace_member_bd_tg` BEFORE DELETE
