...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `canvas_submission_vote` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `canvasSubmissionId` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdById` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_491cfd45e343efed4f6daedce6f` (`canvasSubmissionId`),
  KEY `FK_1b1568219be53c5950e55bdf18a` (`createdById`),
  CONSTRAINT `FK_1b1568219be53c5950e55bdf18a` FOREIGN KEY (`createdById`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_491cfd45e343efed4f6daedce6f` FOREIGN KEY (`canvasSubmissionId`) REFERENCES `canvas_submission` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `format` (
  ...
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `containsTechnicalUser` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `format_member` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('organizer','participant','technical') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'participant',
